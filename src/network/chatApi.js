...
export async function getSupportChat(pageSize, pageNumber) {
  return new Promise(async (resolve, reject) => {
    try {
...
export async function getDiscussionChat(pageSize, pageNumber) {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await getRequest(
...
export async function getActiveChat(roomType, pageSize, pageNumber) {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await getRequest(
