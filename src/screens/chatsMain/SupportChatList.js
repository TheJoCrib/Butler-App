...
import { setSupportChats } from "../../modules/chat/actions";
...
const SupportChatList = ({ navigation }) => {
  ...
  return (
    <MainBackground BGcolor={R.colors.BackgroundLightGrey} showButler>
      {KeyBoardStatus && (
        <View
          style={[
            styles.keyBtnView,
...
const styles = StyleSheet.create({
  ...
  btn: {
    ...
    paddingHorizontal: screenHeightInPercent(4),
    marginTop: screenHeightInPercent(5),
  },
  btnTxt: {
