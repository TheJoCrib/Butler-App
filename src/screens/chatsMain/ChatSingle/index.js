...
import { API_ENDPOINT, SOCKET_API_ENDPOINT } from "../../../config/api";
...
import { getChatRooms } from "../../../modules/common/actions";
import DocumentPickerRN from "react-native-document-picker";
import { uploadAttachment } from "../../../network/commonApi";
...
const ChatSingle = (props) => {
  ...
  const { chatRoomID, endChat } = props.route.params;
