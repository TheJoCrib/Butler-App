...
import countryCode from "../../../utils/phoneCountryCode";
...
const EditProfile = ({ navigation }) => {
  ...
  return (
    <MainBackground showButler={true}>
      ...
      >
        <RoundedBG2 marginTop={screenHeightInPercent(5)}>
          <View
            style={{
              paddingHorizontal: screenWidthInPercent(1),
              paddingTop: 10,
            }}
          >
            ...
            >
              ...
              <InputContainer
                ...
                containerStyle={{
                  ...
                  marginTop: screenHeightInPercent(1.9),
                }}
                showError={false}
                required={true}
                value={phone}
